...
const MultipleDataTableContextMenu = React.createClass({
    ...
    render() {
        ...
        const {actions, subactions, target, activeItems, icons, showContextMenu, ...popoverProps} = this.props;
                ...
                <Menu className="data-table__context-menu" desktop>
                    {actionList.map((action) => {
                        ...
                        return (<MenuItem key={action}
                                          ...
                                          onClick={!menuItems ? this.handleClick.bind(this, action) : undefined}
