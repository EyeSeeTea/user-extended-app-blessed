...
class FormBuilder extends React.Component {
    ...
    validateProps(props) {
        ...
        props.fields
            ...
            .filter(field => props.validateFullFormOnChanges || field.value !== this.state.fields[field.name].value)
    ...
    renderFields() {
        ...
        return this.props.fields.map(field => {
            ...
            const onBlurChangeHandler =
                changeEvent === "onBlur"
                    ? e => {
                          const stateClone = this.updateFieldState(this.getStateClone(), field.name, {
            ...
            return (
                <FieldWrapperComponent
                    key={field.name}
                    style={Object.assign({}, styles.field, this.props.fieldWrapStyle)}
                >
    ...
    handleFieldChange(fieldName, event) {
        ...
        this.setState(this.updateFieldState(stateClone, fieldName, { pristine: false, value: newValue }), () => {
            ...
            if (validatorResult === true) {
                ...
                this.setState(
                    this.updateFieldState(stateClone, fieldName, { valid: false, error: validatorResult }),
                    () => {
        ...
        if ((field.asyncValidators || []).length > 0) {
            ...
            this.setState(this.updateFieldState(stateClone, fieldName, { validating: true }), () => {
                ...
                this.asyncValidators[fieldName] = this.asyncValidationRunner
                    ...
                    .subscribe(status => {
                        this.setState(
                            this.updateFieldState(this.getStateClone(), status.fieldName, {
                                validating: false,
    ...
    validateField(stateClone, fieldName, newValue) {
        ...
        const validatorResult = (field.validators || []).reduce((pass, currentValidator) => {
            if (pass !== true) {
                return pass;
            } else {
